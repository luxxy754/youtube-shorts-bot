...
## Schedule
Runs automatically three times a day via the cron entries in
...
The bot produces the video and can post it automatically. To have it post
straight to your YouTube channel (free - YouTube Data API v3, well within
the free daily quota for the configured upload schedule):
...
If the three `YT_*` secrets are missing, upload cannot run.
